    ...
    >
      <div className="w-[1360px] flex flex-col items-start justify-start gap-[27px] max-w-full">
        <div className="self-stretch flex flex-row items-start justify-center py-0 pr-[21px] pl-5 box-border max-w-full">
          <div className="w-[797px] rounded-19xl bg-royalblue-100 flex flex-row items-start justify-between pt-3.5 px-[52px] pb-2 box-border gap-[20px] max-w-full mq900:flex-wrap mq900:pl-[26px] mq900:pr-[26px] mq900:box-border">
            ...
            <a
              className="[text-decoration:none] h-8 w-[132px] relative leading-[22px] text-[inherit] flex items-center justify-center shrink-0 cursor-pointer z-[1] mq450:text-xl mq450:leading-[18px]"
